...
const routes = [
    {path: '/', title: "小黄友人", component: Index},
    {path: '/search', title: "搜索", component: Search},
    {path: '/search/userList', title: "搜索到的用户", component: SearchResult},
    {path: '/team', title: "部落", component: Team},
    {path: '/team/detail', title: '部落详情', component: TeamDetailPage},
    {path: '/team/add', title: "创建部落", component: TeamAddPage},
    {path: '/team/update', title: "更新部落", component: TeamUpdatePage},
    ...
    {path: '/user/team/join', title: "我加入的部落", component: UserTeamJoinPage},
    {path: '/user/team/create', title: "我创建的部落", component: UserTeamCreatePage},
