    ...
    <van-tabs v-model:active="active">
      <van-tab title="👑 友人推荐">
        <van-pull-refresh
            ...
            @refresh="onRefresh">
          <van-search v-model="userSearch" placeholder="请输入搜索关键词" shape="round" @search="searchUser" @click-left-icon="searchUser" show-action>
            <template #action>
      ...
      <van-tab title="📚 热门博文">
        <van-pull-refresh
            ...
            success-text="刷新成功"
            @refresh="blogRefresh">
          <van-search v-model="blogSearch" placeholder="请输入搜索关键词" shape="round" @search="searchBlog" @click-left-icon="searchBlog" show-action>
            <template #action>
              <div @click="searchBlog">搜索</div>
            </template>
          </van-search>
          <van-list
              v-model:loading="listLoading"
