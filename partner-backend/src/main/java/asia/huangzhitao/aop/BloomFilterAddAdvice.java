...
public class BloomFilterAddAdvice {
     ...
     * @param joinPoint 连接点
     */
    @After("execution(* asia.huangzhitao.service.impl.UserServiceImpl.afterInsertUser(..))")
     ...
     * @param ret ret
     */
    @AfterReturning(value = "execution(long asia.huangzhitao.service.impl.TeamServiceImpl.addTeam(..))", returning = "ret")
     ...
     * @param ret ret
     */
    @AfterReturning(value = "execution(* asia.huangzhitao.service.impl.BlogServiceImpl.addBlog(..))", returning = "ret")
