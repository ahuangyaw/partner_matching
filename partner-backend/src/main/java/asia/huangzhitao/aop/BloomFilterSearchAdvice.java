...
@Component
@Aspect
@ConditionalOnProperty(prefix = "hwang", name = "enable-bloom-filter", havingValue = "true")
@Log4j2
public class BloomFilterSearchAdvice {
     ...
     * @param joinPoint 连接点
     */
    @Before("execution(* asia.huangzhitao.controller.UserController.getUserById(..))")
     ...
     * @param joinPoint 连接点
     */
    @Before("execution(* asia.huangzhitao.controller.TeamController.getTeamById(..))")
    public void findTeamById(JoinPoint joinPoint) {
        ...
        if (!contains) {
            ...
            throw new BusinessException(ErrorCode.PARAMS_ERROR, "没有找到该部落");
        }
    }
     ...
     * @param joinPoint 连接点
     */
    @Before("execution(* asia.huangzhitao.controller.TeamController.getTeamMemberById(..))")
     ...
     * @param joinPoint 连接点
     */
    @Before("execution(* asia.huangzhitao.controller.BlogController.getBlogById(..))")
