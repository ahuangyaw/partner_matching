...
import asia.huangzhitao.model.request.DeleteRequest;
import asia.huangzhitao.model.request.TeamAddRequest;
import asia.huangzhitao.model.request.TeamCoverUpdateRequest;
import asia.huangzhitao.model.request.TeamJoinRequest;
import asia.huangzhitao.model.request.TeamKickOutRequest;
...
public class TeamController {
     ...
     */
    @PostMapping("/add")
    @ApiOperation(value = "添加部落")
    @ApiImplicitParams(
            {@ApiImplicitParam(name = "teamAddRequest", value = "部落添加请求参数"),
     ...
     */
    @PostMapping("/update")
    @ApiOperation(value = "更新部落")
    @ApiImplicitParams({@ApiImplicitParam(name = "teamUpdateRequest", value = "部落更新请求参数"),
            @ApiImplicitParam(name = "request", value = "request请求")})
     ...
     */
    @GetMapping("/{id}")
    @ApiOperation(value = "根据id查询部落")
    @ApiImplicitParams({@ApiImplicitParam(name = "id", value = "部落id")})
     ...
     */
    @GetMapping("/list")
    @ApiOperation(value = "获取部落列表")
    @ApiImplicitParams({@ApiImplicitParam(name = "teamQueryRequest", value = "部落查询请求参数"),
            @ApiImplicitParam(name = "request", value = "request请求")})
     ...
     */
    @PostMapping("/join")
    @ApiOperation(value = "加入部落")
    @ApiImplicitParams({@ApiImplicitParam(name = "teamJoinRequest", value = "加入部落请求参数"),
            @ApiImplicitParam(name = "request", value = "request请求")})
     ...
     */
    @PostMapping("/quit")
    @ApiOperation(value = "退出部落")
    @ApiImplicitParams({@ApiImplicitParam(name = "teamQuitRequest", value = "退出部落请求参数"),
            @ApiImplicitParam(name = "request", value = "request请求")})
    ...
    @ApiImplicitParams({@ApiImplicitParam(name = "deleteRequest", value = "解散部落请求参数"),
            @ApiImplicitParam(name = "request", value = "request请求")})
    ...
    @ApiOperation(value = "获取我创建的部落")
    @ApiImplicitParams({@ApiImplicitParam(name = "teamQuery", value = "获取部落请求参数"),
            @ApiImplicitParam(name = "request", value = "request请求")})
    ...
    @ApiImplicitParams({@ApiImplicitParam(name = "teamCoverUpdateRequest", value = "部落封面更新请求"),
            @ApiImplicitParam(name = "request", value = "request请求")})
