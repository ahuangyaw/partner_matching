...
import asia.huangzhitao.model.request.UpdatePasswordRequest;
import asia.huangzhitao.model.request.UserLoginRequest;
...
import asia.huangzhitao.utils.MessageUtils;
import asia.huangzhitao.utils.ValidateCodeUtils;
...
import static asia.huangzhitao.constants.RedisConstants.REGISTER_CODE_TTL;
import static asia.huangzhitao.constants.RedisConstants.USER_FORGET_PASSWORD_KEY;
import static asia.huangzhitao.constants.RedisConstants.USER_FORGET_PASSWORD_TTL;
import static asia.huangzhitao.constants.RedisConstants.USER_UPDATE_EMAIL_KEY;
import static asia.huangzhitao.constants.RedisConstants.USER_UPDATE_EMAIL_TTL;
import static asia.huangzhitao.constants.RedisConstants.USER_UPDATE_PHONE_KEY;
import static asia.huangzhitao.constants.RedisConstants.USER_UPDATE_PHONE_TTL;
...
public class UserController {
    ...
    public BaseResponse<String> userLogin(@RequestBody UserLoginRequest userLoginRequest, HttpServletRequest request) {
        UserLoginRequestIsEmpty(userLoginRequest);
     ...
     */
    private void UserLoginRequestIsEmpty(UserLoginRequest userLoginRequest) {
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "radius", value = "搜索半径", required = true, dataType = "int"),
            @ApiImplicitParam(name = "request", value = "用户请求", required = true, dataType = "HttpServletRequest")})
